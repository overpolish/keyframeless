> **v1 archive.** Open `Legacy/Keyframeless.xcworkspace` from the repository root. All paths in the historical documentation below are relative to `Legacy/`. Its scaffolding and release tooling are for v1 only. Current development is documented in the [root README](../README.md).
