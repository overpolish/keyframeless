...
vertex MeshBlitData meshBlitVertex(uint vertexID [[vertex_id]]) {
...
fragment float4 meshBlitFragment(MeshBlitData in [[stage_in]], texture2d<float> src [[texture(0)]],
                                 sampler samp [[sampler(0)]]) {
    return src.sample(samp, in.uv);
}

// Per-Type fragment shaders (each includes MeshShaderCommon.h).
#include "MeshShaders_Dithering.h"
#include "MeshShaders_Fluid.h"
#include "MeshShaders_GodRays.h"
#include "MeshShaders_Grainy.h"
#include "MeshShaders_Mesh.h"
#include "MeshShaders_Metaballs.h"
#include "MeshShaders_Neon.h"
#include "MeshShaders_Neuro.h"
#include "MeshShaders_Silk.h"
#include "MeshShaders_Simplex.h"
#include "MeshShaders_Strata.h"
#include "MeshShaders_Warp.h"
