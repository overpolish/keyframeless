...
static inline NSString *MeshAILaneSchemaText(void) {
  return @"Lane labels and value spaces. This is a procedural generator with "
         ...
         @"- \"Color 1\", \"Color 2\", ... : the palette (shared with Mesh). "
         ...
         @"Mesh), each [r, g, b, a] in sRGB 0..1. Color 1 is the base. Set as "
         ...
         @"the rest (shared with Mesh, each [r, g, b, a] sRGB 0..1) are cycled "
         @"across the balls.\n"
         @"\nGod Rays (Type 7):\n"
         ...
         @"Mesh), each [r, g, b, a] in sRGB 0..1. Color 1 is the "
         @"base/backdrop. "
         @"Up to 5 used.\n"
         ...
         @"(shared with Mesh, each [r, g, b, a] sRGB 0..1, back to front) are "
