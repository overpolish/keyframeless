...
- Double-click the mini-canvas, or press Cmd-0 while the mini-canvas is open, to reset its zoom and pan back to aspect-fit (same as the Reset Zoom button in the inspector header). Scroll-wheel or pinch zooms in and out; two-finger drag pans.
