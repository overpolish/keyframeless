...
Each modulation type has Intensity and Frequency knobs in the interval editor popover. Intensity controls how far the value moves; Frequency controls how often. Defaults are 0.5 each.
