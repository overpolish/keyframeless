...
static const KKLaneField kKKLaneFields[] = {
    ...
    {@"choiceAllowsMultiple", nil, nil, KKLaneFieldObject,
    ...
    {@"visibleWhenBitMask", @"visible_when_bit_mask", nil,
     KKLaneFieldIntOmitZero, KKLaneFieldSerialized | KKLaneFieldPickerMeta},
