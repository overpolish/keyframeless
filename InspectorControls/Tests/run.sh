...
for source in InspectorTokens ICValueTextField ICInspectorRow ICSliderView ICSliderRow ICMenuToggleView ICPopUpButton ICInspectorHeader; do
...
xcrun clang -fobjc-arc -fmodules -Wall -Wextra -Werror \
  ...
  "$test_tmp/ICPopUpButton.o" "$test_tmp/ICMenuToggleView.o" "$test_tmp/ICSliderView.o" "$test_tmp/ICSliderRow.o" "$test_tmp/ICInspectorHeader.o" \
