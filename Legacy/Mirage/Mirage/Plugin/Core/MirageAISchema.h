...
static inline NSString *MirageAILaneSchemaText(void) {
  return @"Lane labels and value spaces. This is a Shadertoy-style GLSL "
         ...
         @"\"Mirage\" code lane), and a few shared lanes control timing and "
         @"grain.\n\n"
         ...
         @"coarser). Default 2.\n"
         @"- \"Mirage\": the GLSL (Shadertoy-style) source that draws the "
