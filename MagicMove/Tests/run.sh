...
for suite in ${MM_TEST_SUITES:-LinkedPosesTests ModelTests MatchEndpointsTests CombinedPoseTests EasingTests AddedMotionTests MotionBlurTests ShortcutTests CustomRowTests PositionTests ScaleTests TimingEditorTests OpacityTests RotationTests ResetParameterTests NativeLinksTests}; do
