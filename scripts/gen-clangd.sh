...
blocks = []
for component, path in [('MagicMove', 'MagicMove/MagicMove'), ('MotionTiming', 'MotionTiming/Sources'), ('InspectorControls', 'InspectorControls/Sources'), ('RenderSupport', 'RenderSupport/Sources')]:
    flags = list(base)
    ...
    if component == 'MagicMove':
        for module in ['MotionTiming', 'InspectorControls', 'RenderSupport']:
