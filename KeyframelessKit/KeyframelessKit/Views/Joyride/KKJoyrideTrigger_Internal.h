...
typedef NS_ENUM(NSInteger, KKJoyrideTriggerType) {
  ...
  KKJoyrideTriggerTypePlayingChanged,
  KKJoyrideTriggerTypePlayPauseEdge,
};
...
@property(nonatomic, readonly) NSInteger intArg;       // phase, idx, section, comp, curveType
@property(nonatomic, readonly) NSInteger intArg2;      // phase "on" (0/1), playing (0/1)
