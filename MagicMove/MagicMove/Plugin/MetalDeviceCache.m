...
static MagicMoveMetalDeviceCache *gDeviceCache = nil;

@implementation MagicMoveMetalDeviceCache {
  KKLog *_log;
}

+ (MagicMoveMetalDeviceCache *)deviceCache;
{
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    gDeviceCache = [[MagicMoveMetalDeviceCache alloc] init];
  });
  return gDeviceCache;
}
