---
id: radius
summary: The Radius property in Rounded
---
...
You can also drag the on-screen handle on the canvas to set the radius visually instead of typing a number. Option-click the handle on the viewer or mini-canvas to hide it (or use its Radius pill in the on-screen-controls settings).
