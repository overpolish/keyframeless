...
#import "KKRenderPrimitives.h"

@implementation KKRenderPrimitives
...
+ (nonnull MTLRenderPassDescriptor *)
    createClearRenderPassWithTexture:(nonnull id<MTLTexture>)texture
...
+ (nonnull MTLRenderPipelineDescriptor *)
    createPipelineDescriptorWithVertexFunction:
        (nonnull id<MTLFunction>)vertexFunction
                              fragmentFunction:
                                  (nonnull id<MTLFunction>)fragmentFunction
