...
- Drag the position handle on the inspector mini-viewer. The mini-viewer previews the boundary frame for the keypose you're editing, so you can see exactly where the clip lands. Same modifiers work there.
