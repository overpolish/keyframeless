...
enum { MMTransitionDuration = 1102, MMPositionX = 1300, MMDurationData = 1301, MMPositionAvailableTime = 1302, MMPositionLink = 1303, MMPositionMatch = 1304, MMPositionLegacyMatchOut = 1305,
       MMScale = 1400, MMScaleDuration = 1401, MMScaleDurationData = 1402, MMScaleAvailableTime = 1403, MMScaleLink = 1404, MMScaleMatch = 1405, MMScaleLegacyMatchOut = 1406, MMLinkProperties = 1500 };
_Static_assert(MMTransitionDuration >= 1 && MMLinkProperties <= 9999,
