...
/// (undo / redo) and forwards them to host callbacks. Wraps the content of
/// any plugin remote window so these keystrokes hit the host instead of
/// being eaten as a beep.
