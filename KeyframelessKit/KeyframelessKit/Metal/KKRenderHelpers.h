...
/// Create a Metal render pass descriptor that clears the target texture with a
/// specified color.
/// @return A configured MTLRenderPassDescriptor ready for rendering.
+ (MTLRenderPassDescriptor *)
    createClearRenderPassWithTexture:(id<MTLTexture>)texture
...
+ (MTLRenderPipelineDescriptor *)
    createPipelineDescriptorWithVertexFunction:(id<MTLFunction>)vertexFunction
