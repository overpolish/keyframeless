...
/// Append the shader's code sections for `timeline` to `data`: the "Shader"
...
/// passthrough, so nothing is written. An ABSENT Shader lane is different: the
...
/// param.
void ShaderAppendCodeSections(NSMutableData *data,
