...
/// Build and register a pipeline state in one call. Returns an existing
/// pipeline if already registered. Pass nil for bundleID to use the calling
/// plugin's default Metal library.
