...
/// Compound fill path for the ring: outer rounded rect minus inner rounded rect
/// hole. |expansion| expands the outer boundary outward beyond its steady-state
...
- (void)updatePaths {
  ...
  // The glow then extends inward from there — the ring fill covers the outward
  // half.
  CGFloat halfLW = KKNumberFieldFocusLineWidth / 2.0;
...
- (void)animateIn {
  ...
  // Custom aggressive ease-in — stays near-transparent before snapping to full
  // opacity.
