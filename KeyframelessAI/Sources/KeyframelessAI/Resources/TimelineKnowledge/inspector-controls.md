...
- Reset Zoom: snaps the mini-canvas back to aspect-fit. Equivalent to double-clicking the canvas. Tints accent while the canvas is zoomed in, gray when already at fit, so it doubles as a "zoomed?" indicator.
